...
export const BADGES: readonly BadgeDefinition[] = [
  ...
  },
  {
    ...
    threshold: 2,
    title: "Referral ×2",
    description: "2 friends register you and complete their first GM",
    mintMode: "hub",
  },
  {
    id: 22,
    ...
    threshold: 5,
    title: "Referral ×5",
    description: "5 friends register you and complete their first GM",
    mintMode: "hub",
  },
  {
    id: 23,
    ...
    threshold: 10,
    title: "Referral ×10",
    description: "10 friends register you and complete their first GM",
    mintMode: "hub",
  },
  {
    id: 24,
    ...
    threshold: 20,
    title: "Referral ×20",
    description: "20 friends register you and complete their first GM",
    mintMode: "hub",
  },
] as const;
